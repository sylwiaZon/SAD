...
import (
  ...
  f "kumori.systems/examples/calculator/components/frontend"
  w "kumori.systems/examples/calculator/components/worker"
  q "kumori.systems/examples/calculator/components/queue"
)
